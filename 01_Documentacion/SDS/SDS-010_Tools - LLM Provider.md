...
El objetivo de este documento es definir el diseño técnico del módulo **LLM Provider**, responsable de abstraer la comunicación entre el sistema RAG y los proveedores de modelos de lenguaje, comenzando con **Google Gemini**.

El diseño mantiene los principios arquitectónicos consolidados del proyecto **Mercado Central AI**, garantizando:
...
- Extensibilidad para incorporar nuevos proveedores LLM.

El módulo actúa como una capa de abstracción entre el **Decision Engine** y el proveedor concreto del modelo de lenguaje, evitando dependencias directas con bibliotecas externas como LangChain o Google Gemini.
...
El presente Sprint no contempla:
...
Estas capacidades serán incorporadas en Sprints posteriores.
